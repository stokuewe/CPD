...
- Added sections:
  • Database Connections and Routing (connection lifecycle + gateway abstraction)
- Removed sections: none
- Templates requiring updates:
  • .specify/templates/plan-template.md: ✅ footer updated to v1.2.0
...
**Version**: 1.2.0 | **Ratified**: 2025-09-15 | **Last Amended**: 2025-09-20
